...
<table>
  <tr style="border: 0;">
    ...
    <td style="border: 0;" valign="top"><strong>설명</strong><br>곡률 생성기는 구워진 곡률 맵을 기반으로 마스크를 만듭니다. 마스크에 텍스처 또는 미세한 세부 사항을 혼합하는 옵션입니다.<br><br>곡률 생성기는 단색(흑백) 텍스처를 출력합니다. 결과적으로 레이어에 직접 적용하지 않고 마스크를 생성하는 데 유용합니다.<br><br>구워진 위치 맵은 입력으로 필요합니다. <a href="../../../baking/baking.md">여기서 굽는 방법에 대해 자세히 알아보세요</a>.</td>
  </tr>
</table>
...
<table>
  ...
  <tr>
    <td><strong>대비</strong></td>
    <td>사용자 정의 텍스처의 대비/밝기 감소를 설정합니다.</td>
  </tr>
  <tr>
    <td><strong>밝기</strong></td>
