...
<table>
  <tr style="border: 0;">
    ...
    <td style="border: 0;" valign="top"><strong>설명</strong><br>Dirt 생성기는 곡률, 주변 오클루전을 기반으로 틈새, 가장자리 및 평평한 표면에 Dirt과 그런지의 사실적인 축적을 추가합니다. 또한 선택적으로 [미세 Height] 및 [미세 표준] 맵을 사용하여 더 많은 세부 사항을 추가할 수 있습니다.<br><br>Dirt 생성기는 단색(흑백) 텍스처를 출력합니다. 따라서 마스크를 생성하여 Dirt 또는 그런지 세부 정보를 모델에 추가하는 데 유용합니다.<br><br>구겨진 위치, 곡률, 주변 오클루전 및 세계 공간 표준 맵이 이미지 입력으로 필요합니다. <a href="../../../baking/baking.md">여기서 굽는 방법에 대해 자세히 알아보세요</a>.</td>
  </tr>
</table>
