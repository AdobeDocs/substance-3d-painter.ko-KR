...
description: Substance 3D Painter의 Fibre Glass Edge Wear 생성기 사용 방법을 알아봅니다.
...
<table>
  <tr style="border: 0;">
    <td style="border: 0;" valign="top"><img src="../../../assets/generators/icon_fiber_glass_edge_wear.webp" alt=""/><br><strong>인:</strong> 마스크, 생성기</td>
    <td style="border: 0;" valign="top"><strong>설명</strong><br>파이버 글라스 Edge Wear 생성기는 구워진 곡률 및 앰비언트 오클루전 맵을 바탕으로 사실적인 파이버 글라스 가장자리 마모와 노골적인 세부 사항을 추가합니다. 추가 세부 사항을 위해 선택적으로 마이크로 Height 및 마이크로 노멀 맵을 사용할 수도 있습니다.<br><br>파이버 유리 Edge Wear 생성기는 단색(흑백) 텍스처를 출력합니다. 따라서 마스크를 생성하여 레이어에 섬유 유리 가장자리 마모 세부 사항을 추가하는 데 유용합니다.<br><br>구겨진 위치, 곡률, 앰비언트 오클루전 및 세계 공간 표준 맵이 이미지 입력으로 필요합니다. <a href="../../../baking/baking.md">여기서 굽는 방법에 대해 자세히 알아보세요</a>.</td>
  </tr>
</table>
...
<table>
  ...
  <tr>
    ...
    <td>전체 마모량과 생성기 효과의 전체 가시성을 조정합니다.</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td>가장자리 마모 효과의 부드러움을 조정합니다.</td>
  </tr>
  <tr>
    <td><strong>앰비언트 오클루전 마스크</strong></td>
    <td>앰비언트 오클루전 맵이 결과에 미치는 영향을 조정합니다.</td>
  </tr>
  <tr>
    <td><strong>곡률 두께</strong></td>
    <td>곡률 맵이 결과에 미치는 영향을 조정합니다.</td>
  </tr>
</table>
...
<table>
  ...
  <tr>
    ...
    <td>곡률 유형을 결정합니다. <br><ul><li><strong>표준</strong>: 일반적으로 매우 선명한 결과를 만들지만 더 넓은 세부 사항은 부족할 수 있습니다.</li><li><strong>Sobel</strong>: 표준과 비교했을 때 비슷한 결과를 만들지만 Sobel 필터를 사용하여 노멀 맵을 평가하기 때문에 약간 더 흐립니다.</li><li><strong>매끄럽게</strong>: 정보를 누적하기 위해 다양한 수준의 흐림 효과(예: 밉맵)를 생성합니다. 이 옵션을 선택하면 일반적으로 곡선이 더 매끄러워지지만 세부 묘사가 손실될 수 있습니다.</li></ul></td>
  </tr>
  <tr>
