...
breadcrumb-title: ''
description: 향상된 3D 탐색 및 뷰포트 제어를 위해 Substance 3D Painter에서 3D 연결을 통해 SpaceMouse를 사용하는 방법에 대해 알아봅니다.
...
| 모델 | 설명 | 시각적 |
| --- | --- | --- |
| **소형 모델** | 노브 컨트롤이 있는 기본 모델 | <div><img class="confluence-embedded-image" data-preserve-html="true" src="../assets/3Dconnexion_SpaceMouse-Wireless-400x400.png" width="200"/></div> |
| **프로 모델** | 키보드 단축키를 위한 노브 컨트롤 및 추가 버튼. | <div><img class="confluence-embedded-image" data-preserve-html="true" src="../assets/3Dconnexion_SpaceMouse-Pro-400x400.png" width="200"/></div> |
| **엔터프라이즈 모델** | 노브 컨트롤, 추가 버튼 및 문맥 표시. | <div><img class="confluence-embedded-image" data-preserve-html="true" src="../assets/3Dconnexion_SpaceMouse-Enterprise-400x400.png" width="200"/></div> |
