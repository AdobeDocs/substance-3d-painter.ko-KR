...
breadcrumb-title: ''
description: 일관된 색상 작업 과정을 위해 Substance 3D Painter에서 Adobe ACE 및 ICC 색상 관리를 사용하는 방법에 대해 알아봅니다.
helpx_creative_field: ""
helpx_description: Painter > Features > Color management > Color management with Adobe ACE - ICC
helpx_experience_level: ""
helpx_learn_topic: ""
helpx_tags: ""
title: Adobe ACE를 사용한 색상 관리 - ICC
...
# Adobe ACE를 사용한 색상 관리 - ICC

이 페이지에는 ICC 프로필이 있는 이미지를 사용하는 데 필요한 Adobe Color Engine(ACE)와 관련된 색상 관리 설정이 나열됩니다.
...
| 섹션 | 설정 | 설명 |
| --- | --- | --- |
| **구성** | **색상 관리** | 색상 관리에 사용할 엔진을 정의합니다.가능한 값:<ul data-preserve-html="true"> <li data-preserve-html="true"><strong>레거시</strong>(기본값): 미리 정의된 sRGB/선형 sRGB 감마 색상 교정을 사용합니다.</li> <li data-preserve-html="true"><strong>OpenColorIO</strong>: OCIO 통합을 사용합니다.</li> <li data-preserve-html="true"><strong>Adobe ACE</strong>: ICC 프로필을 지원하는 Adobe Color Engine.</li> </ul> |
|  | **사전 설정 파일 사용** | 활성화되면 json 구성 파일을 통해 색상 관리 설정을 제어할 수 있습니다. |
|  | **사전 설정 파일** | 사전 설정 파일의 경로(json 포맷) 자세한 내용은 아래를 참조하십시오. |
|  |  |  |
| **색상 설정** | **작업 색상 공간** | 엔진이 응용 프로그램 내에서 작업하는 데 사용하는 색상 공간입니다. 이는 텍스처가 변환(가져오기) 또는 변환(내보내기)될 수 있는 색상 공간입니다.가능한 값은 다음과 같습니다.<ul data-preserve-html="true"> <li data-preserve-html="true"><strong>선형 sRGB IEC61966-2.1</strong>(기본값)</li> <li data-preserve-html="true"><strong>ACEScg ACES 작업 영역 AMPAS S-2014-004</strong></li> <li data-preserve-html="true"><strong>선형 Adobe RGB(1998)</strong></li> </ul> |
...
|  | **부동 소수점 이미지** | HDR/EXR 이미지 파일을 가져올 때 기본적으로 사용할 색상 공간. |
