...
Substance 3D Painter에서 페인팅은 수동 도구 또는 자동 작업을 통해 다양한 방법으로 수행할 수 있습니다.

수동 페인팅 도구는 도구 모음(또는 전용 단축키)을 통해 직접 액세스할 수 있습니다. 페인트 도구를 선택하면 해당 속성이 속성 창에 표시됩니다.

각 도구에 대한 자세한 내용은 전용 페이지를 참조하십시오.
...
* [역동적인 획](../painting/dynamic-strokes/dynamic-strokes.md)
* [고급 채널 페인팅](../painting/advanced-channel-painting/advanced-channel-painting.md)
* [벡터 그래픽(.svg 및 .ai)](vector-graphic-svg.md)
* [텍스트 리소스](text-resource.md)
