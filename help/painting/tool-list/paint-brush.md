...
페인트 도구는 다양한 비헤이비어와 설정을 통해 브러시 획을 시뮬레이션하여 3D 메쉬에 페인팅한 느낌을 줍니다.
...
>[!NOTE]
>
> Substance 그래프에 &quot;hardness&quot;(식별자) 매개 변수가 노출된 경우 Hardness [Shortcuts](../../interface/settings/shortcuts.md)로 제어할 수 있습니다.
...
* [도구 모음](../../interface/toolbars.md)에서(또는 키보드 단축키를 통해) 도구를 &quot;실제&quot;로 전환합니다.
