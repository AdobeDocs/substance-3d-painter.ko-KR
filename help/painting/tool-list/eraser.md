...
breadcrumb-title: ''
description: Substance 3D Painter의 지우개 툴을 사용하면 3D 모델에서 페인트와 텍스처를 정밀하게 제어할 수 있습니다.
...
[지우개] 도구는 [페인트] 도구로 일반적인 매개 변수와 비헤이비어를 공유합니다. 브러시에 대한 자세한 내용은 알파 및 스텐실 컨트롤을 [페인트 도구 페이지](paint-brush.md)를 참조하십시오.
...
> * 알파 정보를 무시하는 경우에는 Substance 필터에서 페인트 정보를 검색할 수 있습니다
> 
...
>[!NOTE]
>
> [페인트 도구]와는 반대로 [지우개]는 영향을 받을 채널만 정의할 수 있습니다. 셸프에서 리소스를 로드하여 각 채널에 영향을 줄 수는 없습니다.
