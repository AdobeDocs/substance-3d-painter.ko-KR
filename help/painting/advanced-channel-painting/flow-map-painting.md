...
breadcrumb-title: ''
description: Substance 3D Painter에서 플로우 맵을 페인팅하여 재료의 흐름 방향과 이방성 효과를 제어하는 방법을 알아봅니다.
...
16 x 16 픽셀의 표준 맵 텍스처를 만듭니다. 색상은 128, 255, 128이어야 합니다. ![](../../assets/up-dx.png)\
...
브러쉬 매개 변수에서 경로 따르기 기능을 활성화합니다. 표준 맵 텍스처(1단계)를 표준 채널 슬롯에 로드합니다. 다른 채널을 비활성화합니다.

![](../../assets/brush-settings-1.png){width="300px"}

## 4단계 : 페인트 !

경로 따르기 설정을 활성화한 상태로 메시를 페인트하면 브러쉬 선이 방향을 표준 맵에 그립니다.
