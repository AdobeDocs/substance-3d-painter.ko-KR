...
2D 보기는 현재 선택한 [텍스처 집합](../texture-set/texture-set.md)에서 메시 UV 섬을 표시합니다. 이를 통해 레이어 스택의 텍스처를 볼 수 있을 뿐만 아니라 메시 UV 섬의 페인트를 볼 수도 있습니다.
...
프로젝트를 만들 때 정의된 워크플로우에 따라 2D 보기의 모양과 동작이 다를 수 있습니다.
