...
breadcrumb-title: ''
description: Substance 3D Painter에서 텍스처 집합 설정을 구성하여 텍스처 해상도 및 채널 속성을 제어하는 방법을 알아봅니다.
...
이러한 설정은 채널이 생성되는 방식, 특히 채널이 구운 텍스처(메시 맵)와 결합되는 방식에 대한 다양한 동작을 제어합니다.

| 설정 | 설명 |
| --- | --- |
| **일반 믹싱** | &quot;불러온 표준 맵&quot;을 &quot;표준&quot; 채널과 결합하는 방법을 제어합니다. 가능한 값은 다음과 같습니다.<ul data-preserve-html="true"><li data-preserve-html="true"><strong> </strong> 바꾸기 : &quot;구워진 표준 맵&quot;을 무시하고 이 텍스처 집합에 대해서만 &quot;표준&quot; 채널을 사용합니다. 구운 표준 맵 위에 페인트하는 데 사용할 수 있습니다. 자세한 내용은 [고급 채널 페인팅](../../painting/advanced-channel-painting/normal-map-painting.md)설명서를 참조하십시오. 표준 채널이 없거나 표준 채널 출력이 비어 있는 경우 구워진 표준 맵이 계속 사용됩니다.</li><li data-preserve-html="true"><strong> </strong> 결합(기본값) : 세부 방향 함수를 사용하여 &quot;표준&quot; 채널과 &quot;구워진 표준 맵&quot;을 결합합니다.</li></ul>  **참고:** 채널의 목록에 없는 경우 이 설정을 사용하지 않도록 설정할 수 있습니다. 채널이 없으면 기본 믹싱 값이 사용됩니다. |
| **일반 메서드 Height** | Height 채널을 표준 맵으로 변환하는 데 사용할 메서드를 제어합니다. 가능한 값은 다음과 같습니다.<ul data-preserve-html="true"><li data-preserve-html="true"><strong>선명</strong>: 노이즈와 앨리어싱이 발생할 수 있으므로 좀 더 정의된 표준 맵을 만듭니다. 패브릭과 같은 반복 패턴에 맞게 조정됩니다.</li><li data-preserve-html="true"><strong>매끄럽게(Sobel)</strong>(기본값): 세부 사항이 손실될 위험이 있는 Sobel 필터를 사용하여 더 매끄러운 표준 맵을 만듭니다. 대부분의 경우에 적용됩니다.</li></ul> |
| **주변 오클루전 믹싱** | &quot;구워진 앰비언트 오클루전&quot;를 &quot;앰비언트 오클루전&quot; 채널과 결합하는 방법을 제어합니다. 가능한 값은 다음과 같습니다.<ul data-preserve-html="true"><li data-preserve-html="true"><strong> </strong> 바꾸기 : &quot;구워진 앰비언트 오클루전&quot;은 무시하고 이 텍스처 집합에 대해서만 &quot;앰비언트 오클루전&quot; 채널을 사용합니다. 구운 주변 오클루전 위에 페인트를 칠하는 데 사용할 수 있습니다. 자세한 내용은 [고급 채널 페인팅](../../painting/advanced-channel-painting/ambient-occlusion-painting.md) 설명서를 참조하십시오.  </li><li data-preserve-html="true"><strong> </strong> 곱하기(기본값) : 곱하기 작업을 사용하여 &quot;앰비언트 오클루전&quot; 채널과 &quot;구워진 앰비언트 오클루전&quot;를 결합합니다.  </li></ul>  **참고:** 채널의 목록에 없는 경우 이 설정을 사용하지 않도록 설정할 수 있습니다. 채널이 없으면 기본 믹싱 값이 사용됩니다. |
...
메시 맵은 필터, 스마트 재질 및 스마트 마스크를 사용하여 텍스처의 품질을 높이는 데 사용되는 메시 및 텍스처 세트 고유의 구워진 텍스처입니다. 자세한 내용은 [굽기](../../baking/baking.md)설명서를 참조하십시오.
