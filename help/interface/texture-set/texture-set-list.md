...
**텍스처 집합 목록** 창에 프로젝트의 현재 3D 모델의 모든 재질 ID가 표시됩니다. 이를 통해 모델의 각 재질과 연결된 레이어 스택 및 전용 설정을 전환하고 볼 수 있습니다.

[텍스처 세트 목록] 창의 주요 목적은 한 재질을 다른 재질로 전환하여 각 재질과 관련된 레이어 스택에 액세스할 수 있도록 하는 것입니다.\
...
* **이름 편집** : 텍스처 집합의 이름을 바꿀 수 있습니다. 이 이름은 텍스처를 내보내는 동안에도 사용됩니다. 텍스처 세트 이름을 두 번 클릭하여 이름을 바꿀 수도 있습니다.
