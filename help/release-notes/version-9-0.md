...
<b>Substance 3D Painter 9.0</b>에서는 새로 고친 기본 콘텐츠뿐만 아니라 3D 뷰포트에서 다시 편집할 수 있는 패스를 사용하여 획을 페인트하는 새로운 방법을 소개합니다.
...
<b>패스를 따라 페인트</b> 도구는 3D 뷰포트에서 선을 페인트하는 새로운 방법입니다. 다른 애플리케이션과 마찬가지로 3D 오브젝트 표면의 점으로 제어되는 베지어 기반 곡선을 만들어 패턴을 그릴 수 있습니다. Substance 재질과 함께 이 새로운 도구는 많은 새로운 가능성을 열 수 있습니다.

* <b>점이 있는 패스로 제어되는 페인트 선을 만드는 새로운 도구</b>\
...
* <b>대칭, 모양 마스크, 역동적인 획 등과 같은 다른 페인트 기능과 호환</b>\
  일반 페인트 선의 여러 설정은 패스 도구와 함께 사용할 수 있습니다.

  * 대칭성을 활성화하면 패스만 관리하면서 여러 번 패스를 그릴 수 있습니다.
  * 지오메트리 마스크가 활성화된 레이어에 있는 패스는 숨겨진 지오메트리 아래에 페인트할 수 있습니다

  대칭 속성의 도움으로 두 번 익사하는 경로를 보여 주는 ![GIF](../assets/v90_path_symmetry.gif)
...
새로운 패스 동반 페인트 기능을 활용하기 위해 이 버전에는 몇 가지 새로운 도구 사전 설정이 포함되어 있습니다.
