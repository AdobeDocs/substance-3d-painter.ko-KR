...
이 버전에서는 [OpenColorIO](https://opencolorio.org/)&#x200B;(약식 OCIO) 버전 2를 지원하는 색상 관리를 도입했습니다.
...
이제 2D 및 3D 보기를 고정 해제하여 다른 위치로 이동할 수 있습니다. 예를 들어 2D 보기가 다른 화면에 있는 동안 기본 화면에 3D 보기를 표시하는 경우.
...
* **색상 관리와 호환**\
  도킹되지 않은 뷰는 고유한 색상 관리 변환이 있어 다른 모니터에서 더 쉽게 관리할 수 있습니다.
