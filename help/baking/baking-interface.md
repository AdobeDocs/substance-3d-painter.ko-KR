---
title: 베이킹 인터페이스
description: '[베이킹] 모드 인터페이스가 [페인팅] 모드와 어떻게 다른지 알아봅니다.'
...
**베이킹 모드**&#x200B;에 액세스하려면 뷰포트의 오른쪽 상단에 있는 (구운) 크루아상 버튼을 클릭합니다. 또는 [키보드 단축키&#x200B;](../interface/settings/shortcuts.md)**F8**&#x200B;를 사용하거나 **모드 > 메시 맵 굽기**&#x200B;를 선택합니다
