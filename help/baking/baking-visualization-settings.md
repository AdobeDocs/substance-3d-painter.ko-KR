...
<td><b>품질</b></td>
<td>낮은 폴리 메시 표면의 Specular 반사 품질을 제어합니다. 높은 값을 사용하면 반사에서 더 나은 충실도를 얻을 수 있지만, 높은 값은 성능에 영향을 줄 수 있습니다. 값이 낮으면 음영에 노멀 맵이 있는 이음새가 생길 수 있습니다(참고: 표시 문제일 뿐입니다).</td>
</tr><tr><td><b>거칠기</b></td>
<td>뷰포트에 있는 낮은 폴리 메시 재질의 거칠기를 제어합니다.</td>
</tr><tr><td><b>금속재질</b></td>
<td>뷰포트에 있는 낮은 폴리 메시 재질의 금속성을 제어합니다.</td>
</tr><tr><td><b>AO 강도</b></td>
<td>구워진 앰비언트 오클루전이 뷰포트의 낮은 폴리 망 음영에 기여하는 정도를 제어합니다.</td>
</tr><tr><td><b>노멀 구부리기</b></td>
<td>활성화된 경우 구운 표준 구부리기를 사용하여 뷰포트에서 폴리 낮은 메시 음영을 개선합니다.</td>
</tr><tr><td><b>노멀 구부리기 확산 양</b></td>
<td>표준 구부리기가 확산 음영에 미치는 영향을 제어합니다.</td>
</tr><tr><td><b>노멀 구부리기 반사 양</b></td>
<td>표준 구부리기가 Specular 음영에 미치는 영향을 제어합니다.</td>
</tr></tbody></table>
