...
Painter의 베이킹 과정에 대한 자세한 내용은 다음 페이지를 참조하십시오.

* [베이킹 모드 인터페이스](baking-interface.md)
* [메시 맵을 분리하는 방법](how-to-bake-mesh-maps.md)
* [굽기 시각화 설정](baking-visualization-settings.md)
* [기울이기 보정](skew-correction.md)

[베이킹] 모드에 대한 간단한 개요는 비디오 튜토리얼을 참조하십시오.
