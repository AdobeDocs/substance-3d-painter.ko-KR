---
helpx_url: "https://helpx.adobe.com/kr/substance-3d-painter/getting-started/system-requirements.html"
breadcrumb-title: ''
...
UV 타일 워크플로우를 사용할 때 좋은 성능을 얻으려면 다음을 사용하는 것이 좋습니다.
...
* 베이킹 시 Ryzen CPU의 충돌은 BIOS를 업데이트하여 해결할 수 있습니다.
