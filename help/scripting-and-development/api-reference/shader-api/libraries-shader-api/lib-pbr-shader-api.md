---
helpx_url: "https://helpx.adobe.com/kr/substance-3d-painter/scripting-and-development/api-reference/shader-api/libraries-shader-api/lib-pbr-shader-api.html"
breadcrumb-title: ''
description: Substance 3D Painter용 Lib PBR 셰이더 API 참조에 액세스하여 사용자 정의 셰이더에서 물리적 기반 렌더링 자료를 만듭니다.
...
**공용 함수:** *normal\_distrib* *fresnel* *G1* *visibility* *horizonFading* *pbrComputeDisperse* *pbrComputeSpecular* *pbrComputeBRDF*
...
Specular 기여도 계산을 위해 만들어진 샘플 수를 나타내는 int입니다. 품질이 높을수록 성능이 향상됩니다.
...
표면을 통해 누출되는 Specular 반사를 제어하는 데 사용되는 값입니다.
...
<https://marmosetco.tumblr.com/post/81245981087>의 가로 페이드 트릭
...
보는 사람의 눈까지 마이크로패싯 Specular 반사 계산
