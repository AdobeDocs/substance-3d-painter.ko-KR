...
# Lib PBR Aniso - 셰이더 API

## lib-pbr-aniso.glsl

**공용 함수:** *normal\_distrib* *G1* *visibility* *cook\_torrance\_contrib* *importanceSampleGCX* *probabilityGCX* *pbrComputeSpecularAnisotropic*
