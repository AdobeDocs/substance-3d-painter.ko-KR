...
맨 위 줄에는 만들 수 있는 모든 텍스처 유형이 나열됩니다.
...
| 이름 | 설명 |
| --- | --- |
| **표준 OpenGL** | 구워진 표준과 텍스처 세트의 표준 채널의 OpenGL 형식으로 결합된 표준 맵 |
| **일반 DirectX** | 구워진 표준과 텍스처 세트의 표준 채널의 DirectX 형식으로 결합된 표준 맵 |
| **혼합된 AO** | 구워진 주변 오클루전과 텍스처 세트의 주변 오클루전 채널이 결합된 주변 오클루전. |
| **확산** | **기본 색상** 및 **금속** 채널에서 생성된 확산 텍스처입니다(금속 영역은 검정색으로 바뀜). |
| **Specular** | **기본 색상** 및 **금속성** 채널에서 Specular 텍스처가 생성되었습니다. |
| **광택** | 거칠음 채널의 반전에서 생성되는 광택 텍스처입니다. |
| **Unity4 확산** | 사용되지 않습니다. Unity 4 셰이더와 일치하도록 **기본 색상** 채널에서 생성된 확산 텍스처입니다. |
| **Unity4 광택** | 사용되지 않습니다. Unity 4 셰이더와 일치하도록 **거칠음** 및 **금속** 채널에서 생성된 광택 텍스처입니다. |
| **반사** | 텍스처입니다. 여기서 흰색은 유전체를 나타내고 다른 색상은 금속 재료를 나타냅니다. |
| **1/ior** | 1을 **IOR** 값으로 나눈 텍스처입니다. **IOR**&#x200B;은(는) 금속 맵에서 생성됩니다. 유전체는 1.4, 금속(검정색)은 100입니다. |
| **광택<sup>2</sup>** | **광택** 채널의 정사각형 버전(**광택** \* **광택**) |
| **f0** | 반사도 값을 fresnel 0으로 포함하는 텍스처(유전체의 경우 0.04, 금속재의 경우 1.0). |
